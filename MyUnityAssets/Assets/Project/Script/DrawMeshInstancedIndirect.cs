...
public class DrawMeshInstancedIndirect : MonoBehaviour
{
    ...
    private void Setup()
    {
        gameObj = new GameObject("test");
        meshC = gameObj.AddComponent<MeshCollider>();
    ...
    private void Update()
    {
        ...
        properties[0].mat[13] += 0.01f;
        Graphics.DrawMeshInstancedIndirect(mesh, 0, material, meshCombine.bounds, argsBuffer);
    }
